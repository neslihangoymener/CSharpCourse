...
namespace Collections
{
    class Program
    {
        ...
        private static void List()
        {
            ...
            cities.Add("Ankara"); //listenin sonuna yeni kayıt ekler
            cities.Add("İstanbul");
            ...
            var index = customers.IndexOf(customer2); //listenin kaçıncı elemanı olduğu
            Console.WriteLine("Index : {0}", index);

            customers.Add(customer2);

            var index2 = customers.LastIndexOf(customer2); //listenin sondan kaçıncı elemanı olduğu
            Console.WriteLine("index2 : {0}", index2);

            customers.Insert(0, customer2); //listenin istediğin yerine yeni kayıt atar

            customers.Remove(customer2); // listeden bulduğu ilk değeri siler,çıkar. Devam etmez.
